...
@Service
public class ReservasInternoVooClient {

    private final RestClient restClient;

    public ReservasInternoVooClient(
        @Value("${reservas-interno-voo.url}") String urlServico,
        @Value("${reservas-interno-voo.client-id}") String clientId,
        @Value("${reservas-interno-voo.client-secret}") String clientSecret
    ) {
